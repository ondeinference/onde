...
|------|------|-------------|
| `model_id` | String | Full model identifier (e.g. `"black-forest-labs/FLUX.1-schnell"`) |
...
#   "expected_size_bytes" => 23782506688
# }
```
...
[✓] FLUX.1 Schnell              44.92 GB /   22.15 GB  (Black Forest Labs)
[✓] Gemma 3n E2B                20.33 GB /   10.17 GB  (Google)
[✓] Gemma 3n E4B                29.31 GB /   14.66 GB  (Google)
[✓] Phi-3.5-mini                14.24 GB /    7.12 GB  (Microsoft)
[✓] Qwen 2.5 1.5B (GGUF)        1.84 GB /  940.4 MB  (Qwen / Alibaba)
[✓] Qwen 2.5 3B (GGUF)          3.59 GB /    1.80 GB  (Qwen / Alibaba)

Total on disk: 114.22 GB
```
