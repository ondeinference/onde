...
impl GgufModelConfig {
    ...
    pub(crate) fn from_supported_model_id(model_id: &str) -> Option<Self> {
        match model_id {
            ...
            super::models::BARTOWSKI_QWEN25_CODER_1_5B_INSTRUCT_GGUF => {
                Some(Self::qwen25_coder_1_5b())
            }
            super::models::BARTOWSKI_QWEN25_CODER_3B_INSTRUCT_GGUF => Some(Self::qwen25_coder_3b()),
